...
<div class="app-container calendar-list-container">
  ...
  <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
    <el-table-column
        ...
        sortable
        type="index"
        :index="(index)=>{return (index+1) + (listQuery.page-1)*listQuery.limit}"
        align="center"
        width="50"
      />
...
export default {
  ...
  created() {
    this.getList();
    this.userManager_btn_edit = this.buttons['/system/user/edit'] || false;
    this.userManager_btn_del = this.buttons['/system/user/remove'];
    this.userManager_btn_add = this.buttons['/system/user/add'];
  },
  computed: {
    ...mapGetters([
      'buttons'
